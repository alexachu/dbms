...
INSERT INTO EMP(EMPNO,ENAME,JOB,SALARY,COMM,DEPTNO)VALUES(7499,'ALLEN','SALESMAN',1600,300,30),(7521,'WARD','SALESMAN',1250,500,30),(7654,'MARTIN','SALESMAN',1250,1400,30);
...
SELECT ENAME,SALARY+IFNULL(COMM,0) AS Total_of_salary FROM EMP;

SELECT ENAME,SALARY*12 AS Annual_Salary  FROM EMP;

SELECT ENAME FROM EMP WHERE DATE_JOIN='03-DEC-81';

SELECT ENAME,SALARY+IFNULL(COMM,0) AS Total_of_salary FROM EMP WHERE ENAME='MILLER';
